...
contract NTU_PASS is ERC721Enumerable, Ownable {
    ...
    //uint256 public cost = 10 ** 18;  //The price of each NFT (0.0001 ether)
    uint256 public maxSupply = 10;    //Maximum supply (20)
    uint256 public maxMintAmount = 1;  //Maximum mint limitation per transaction (3)
    ...
    constructor(string memory _initBaseURI) ERC721("NTU_PASS", "NTU") Ownable(msg.sender) {
